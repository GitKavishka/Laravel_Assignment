                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Name" value="{{ $category->name }}"  > <!-- Add autocomplete attribute -->
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" readonly name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ $category->slug }}" > <!-- Add autocomplete attribute -->
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
