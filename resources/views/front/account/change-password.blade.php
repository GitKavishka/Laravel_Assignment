            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <form action="{{ route('front.account.processChangePassword') }}" method="post" id="changePasswordForm" name="changePasswordForm">
                            @csrf
...
$("#changePasswordForm").submit(function(e){
     ...
     $.ajax({
        url: '{{ route("front.account.processChangePassword") }}',
        type: 'post',
